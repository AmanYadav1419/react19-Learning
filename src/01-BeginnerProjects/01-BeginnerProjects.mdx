...
- here is the code of the second beginner project that is `Meals API Fetch Application` :-
...
- here is the code of the second beginner project that is `Calculator Application` :-
...
- here is the code of the second beginner project that is `Toggle BackgroundColor Application` :-
